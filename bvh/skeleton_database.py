...
own_contact_name = ['LeftFoot', 'RightFoot']
rokoko_contact_name = ['LeftToeBase', 'RightToeBase']


class SkeletonDatabase:
    names = ['Mixamo', 'Elephant', 'Crab_dance', 'Xia', 'Own', 'Rokoko']
    corps_names = [mixamo_corps_name, elephant_corps_name, crab_dance_corps_name, xia_corps_name, own_bvh_name, rokoko_bvh_name]
    contact_names = [mixamo_contact_name, elephant_contact_name, crab_dance_contact_name, xia_contact_name, own_contact_name, rokoko_contact_name]
